...
import { Archivo, DM_Mono, Geist, Geist_Mono } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${geistSans.variable} ${geistMono.variable} ${archivo.variable} ${dmMono.variable} h-full antialiased`}
    >
